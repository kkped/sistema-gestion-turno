...
import { FaBalanceScale, FaFileSignature, FaShieldAlt, FaUserEdit, FaSearch, FaHandshake } from "react-icons/fa";
    ...
    return (
        <div className="p-8 min-h-screen">
            <div className="max-w-5xl mx-auto space-y-10">
                <h2 className="text-4xl font-bold text-center text-white">Servicios Disponibles</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {services.map((service) => (
                        <div
                            key={service.id}
                            className="bg-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition transform hover:scale-105 flex flex-col items-center text-center"
                        >
                            ...
                            <Link
                                to={service.link}
                                className="px-5 py-2 bg-blue-600 text-white font-semibold rounded-full hover:bg-blue-700 transition"
                            >
                                Más Información
                            </Link>
                        </div>
