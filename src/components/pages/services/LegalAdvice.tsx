...
const LegalAdvice: React.FC = () => {
    ...
    return (
        <div className="max-w-3xl mx-auto p-8 bg-white shadow-lg rounded-lg mt-10">
            <h2 className="text-3xl font-bold text-blue-800 mb-4">Asesoría Legal</h2>
            
            {/* Descripción del servicio */}
            <p className="text-gray-700 mb-6">
                Nuestro servicio de Asesoría Legal está diseñado para brindarte la orientación profesional 
                que necesitas en temas legales complejos, ayudándote a tomar decisiones informadas y proteger 
