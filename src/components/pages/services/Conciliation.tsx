...
const Conciliation: React.FC = () => {
    ...
    return (
        <div className="max-w-3xl mx-auto p-8 bg-white shadow-lg rounded-lg mt-10">
            <h2 className="text-3xl font-bold text-blue-800 mb-4">Conciliación</h2>
            
            {/* Descripción del servicio */}
            <p className="text-gray-700 mb-6">
                El servicio de Conciliación permite a las partes resolver conflictos de manera amistosa 
                y efectiva, promoviendo acuerdos satisfactorios para todas las partes involucradas. 
                Ahorra tiempo y evita complicaciones legales innecesarias.
            </p>
