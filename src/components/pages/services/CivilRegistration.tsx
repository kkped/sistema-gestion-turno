...
const CivilRegistration: React.FC = () => {
    ...
    return (
        <div className="max-w-3xl mx-auto p-8 bg-white shadow-lg rounded-lg mt-10">
            <h2 className="text-3xl font-bold text-blue-800 mb-4">Trámite de Registro Civil</h2>
            
            {/* Descripción del servicio */}
            <p className="text-gray-700 mb-6">
                Nuestro servicio de Trámite de Registro Civil te permite gestionar inscripciones de nacimientos, 
                defunciones, matrimonios y otros eventos importantes. Asegura la formalidad de estos eventos 
                con la ayuda de nuestros profesionales.
            </p>
